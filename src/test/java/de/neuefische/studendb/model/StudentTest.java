...
class StudentTest {
    ...
    public void testSetAndGetName(){
        // Given
        Student student = new MediaScienceStudent("Jane Doe", "42");
    ...
    private static Arguments[] provideTestEqualsArguments(){
        return new Arguments[]{
            Arguments.of(new MediaScienceStudent("Jane", "42"), new MediaScienceStudent("Jane","42"), true),
            Arguments.of(new MediaScienceStudent("Jane", "42"), new MediaScienceStudent("John","42"), false),
        };
    }
    ...
    public void testHashCode(){
        // Given
        Student studentA = new MediaScienceStudent("Jane", "42");
        Student studentB = new MediaScienceStudent("Jane", "42");
